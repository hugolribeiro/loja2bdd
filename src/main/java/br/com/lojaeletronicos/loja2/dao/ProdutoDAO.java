package br.com.lojaeletronicos.loja2.dao;
...
//    public ProdutoDTO getByCodigoProduto(String codigoProduto) throws SQLException {
//        try (PreparedStatement pstm = conexao.prepareStatement(
//                "SELECT id,codigo_produto, nome, descricao, " +
//                        "preco, data_entrada, quantidade " +
//                        "FROM PRODUTO where codigo_produto = ?;")) {
//
